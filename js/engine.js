...
async function loadG2P(baseUrl = '') {
  ...
  // Full dictionary. Day 6 lines are not in the 219-word practice subset.
...
export { loadG2P, expectedPhoneSequence, forcedAlignGop, aggregate, normalizeText, tokenizeWords, dictionaryCoverage };
